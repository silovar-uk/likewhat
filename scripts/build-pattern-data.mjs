...
const catalog={schemaVersion:2,generatedAt,referenceCount:patterns.length,records};
...
const coverageHistory={
  ...
  label:'Wave 3 / 63 → 78',
  waveIds:[...wave3Ids],
  before:wave3Before.map(compact),
  after:wave3After.map(compact)
};
...
if(catalogBytes>350*1024)console.warn('Catalog raw size exceeds 350 KB; consider a more aggressive compact schema.');
